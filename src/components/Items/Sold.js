function Sold () {
    return (<section className="sold" id="sold">
        <div className="section-header"><strong>Sold</strong></div>
        <div className="item">
            <div className="item-container container">
                <div className="item-image"><img src="shoes-photos/shatteredbackboard.webp" alt="" className="item-photo-img"/></div>
                <ul className="item-description">
                    <li className="item-name"><a>Jordan 1 Retro Shattered Backboard</a></li>
        ...
        <div className="item">
            <div className="item-container container">
                <div className="item-image"><img src="shoes-photos/jordan-fragment.webp" alt="" className="item-photo-img"/></div>
                <ul className="item-description">
                    <li className="item-name"><a>Jordan 1 Retro Fragment</a></li>
                    <li className="item-size"><a><select name="size">
                        <optgroup label="Men's Sizes">
                            <option> 3 UK / 35,5 EU/ 5 US</option>
                            <option>6,5 UK / 40 EU/ 7,5 US</option>
